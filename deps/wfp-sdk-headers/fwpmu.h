...
/* ==========================================================================
 * NCP compatibility additions (v1.9.2)
 * mingw-w64 fwpmu.h lacks the FWPM session/filter flags, FWP_E_* error
 * codes and all built-in layer/condition GUIDs (and libfwpuclnt.a exports
 * no GUID data symbols). Values verified against the Windows 10 SDK
 * fwpmu.h/fwpmk.h (10.0.10240 / 10.0.26100), OpenVPN block_dns.c and
 * wireguard-windows types_windows.go.
 * GUID definitions live in src/core/src/ncp_wfp_guids.cpp.
 * ========================================================================*/
#ifndef FWPM_SESSION_FLAG_DYNAMIC
#define FWPM_SESSION_FLAG_DYNAMIC 0x00000001
#endif

#ifndef FWPM_FILTER_FLAG_NONE
...
#define FWP_E_CALLOUT_NOT_FOUND           ((DWORD)0x80320001L)
#define FWP_E_CONDITION_NOT_FOUND         ((DWORD)0x80320002L)
#define FWP_E_FILTER_NOT_FOUND            ((DWORD)0x80320003L)
#define FWP_E_LAYER_NOT_FOUND             ((DWORD)0x80320004L)
#define FWP_E_PROVIDER_NOT_FOUND          ((DWORD)0x80320005L)
#define FWP_E_PROVIDER_CONTEXT_NOT_FOUND  ((DWORD)0x80320006L)
#define FWP_E_SUBLAYER_NOT_FOUND          ((DWORD)0x80320007L)
#define FWP_E_NOT_FOUND                   ((DWORD)0x80320008L)
#define FWP_E_ALREADY_EXISTS              ((DWORD)0x80320009L)
#define FWP_E_IN_USE                      ((DWORD)0x8032000AL)
#endif

#ifdef __cplusplus
extern "C" {
#endif
extern const GUID FWPM_LAYER_ALE_AUTH_CONNECT_V4;    /* c38d57d1-05a7-4c33-904f-7fbceee60e82 */
extern const GUID FWPM_LAYER_ALE_AUTH_CONNECT_V6;    /* 4a72393b-319f-44bc-84c3-ba54dcb3b6b4 */
extern const GUID FWPM_LAYER_OUTBOUND_TRANSPORT_V4;  /* 09e61aea-d214-46e2-9b21-b26b0b2f28c8 */
extern const GUID FWPM_CONDITION_IP_PROTOCOL;        /* 3971ef2b-623e-4f9a-8cb1-6e79b806b9a7 */
extern const GUID FWPM_CONDITION_IP_REMOTE_ADDRESS;  /* b235ae9a-1d64-49b8-a44c-5ff3d9095045 */
extern const GUID FWPM_CONDITION_IP_REMOTE_PORT;     /* c35a604d-d22b-4e1a-91b4-68f674ee674b */
#ifdef __cplusplus
}
#endif
