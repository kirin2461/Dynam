...
FlowShaper::FlowShaper(FlowShaper&& o) noexcept     : config_(std::move(o.config_)),       burst_state_(o.burst_state_),       packets_in_current_burst_(o.packets_in_current_burst_),       current_burst_target_(o.current_burst_target_),       last_packet_time_(o.last_packet_time_),       pause_end_time_(o.pause_end_time_),       upload_bytes_(o.upload_bytes_.load()),       download_bytes_(o.download_bytes_.load()),       packet_queue_(std::move(o.packet_queue_)),       running_(o.running_.load()),       worker_thread_(std::move(o.worker_thread_)),       send_callback_(std::move(o.send_callback_)),       cumulative_weights_(std::move(o.cumulative_weights_)),       dummy_marker_(o.dummy_marker_),       session_key_(o.session_key_),       stats_(o.stats_) {     o.running_.store(false); }
FlowShaper& FlowShaper::operator=(FlowShaper&& o) noexcept {     if (this != &o) {         stop();         if (worker_thread_.joinable()) worker_thread_.join();         config_ = std::move(o.config_);         burst_state_ = o.burst_state_;         packets_in_current_burst_ = o.packets_in_current_burst_;         current_burst_target_ = o.current_burst_target_;         last_packet_time_ = o.last_packet_time_;         pause_end_time_ = o.pause_end_time_;         upload_bytes_.store(o.upload_bytes_.load());         download_bytes_.store(o.download_bytes_.load());         packet_queue_ = std::move(o.packet_queue_);         running_.store(o.running_.load());         worker_thread_ = std::move(o.worker_thread_);         send_callback_ = std::move(o.send_callback_);         cumulative_weights_ = std::move(o.cumulative_weights_);         dummy_marker_ = o.dummy_marker_;         session_key_ = o.session_key_;         stats_.packets_shaped.store(o.stats_.packets_shaped.load());         stats_.packets_original.store(o.stats_.packets_original.load());         stats_.bytes_original.store(o.stats_.bytes_original.load());         stats_.bytes_shaped.store(o.stats_.bytes_shaped.load());         stats_.dummy_packets.store(o.stats_.dummy_packets.load());         stats_.keepalives_sent.store(o.stats_.keepalives_sent.load());         stats_.packets_split.store(o.stats_.packets_split.load());         stats_.packets_merged.store(o.stats_.packets_merged.load());         stats_.bursts_generated.store(o.stats_.bursts_generated.load());         stats_.pauses_injected.store(o.stats_.pauses_injected.load());         stats_.current_upload_ratio = o.stats_.current_upload_ratio;         stats_.overhead_percent = o.stats_.overhead_percent;         o.running_.store(false);     }     return *this; }
